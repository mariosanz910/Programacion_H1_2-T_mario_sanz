...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($id_usuario)) {
        die("Error: No se recibió un ID de usuario válido en el formulario.");
    }
    ...
    <div class="container mt-5">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form method="POST">
                    <div class="mb-3">
                        <label for="nombre_paquete" class="form-label">Nombre de su paqute: <strong>el paquete de deporte solo está disponible con el pack anual</strong></label>
